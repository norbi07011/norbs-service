...
const TeamCarousel3D: React.FC = () => {
  ...
  const teamMembers: TeamMember[] = [
    ...
    },
    {
      ...
      description: t('team_member_2_desc'),
      image: "https://picsum.photos/300/300?random=102",
      skills: ["UI/UX Design", "Branding", "Creative Strategy", "Adobe Suite"],
      experience: "8+ lat",
      social: {
        linkedin: "#",
        instagram: "#",
    ...
    },
    {
      ...
      description: t('team_member_3_desc'),
      ...
      social: {
        github: "#",
        linkedin: "#",
        email: "michal@norbs.nl"
      }
    },
    {
      id: 4,
      name: "Katarzyna Jankowska",
      role: t('marketing_specialist'),
      description: t('team_member_4_desc'),
      ...
      social: {
        linkedin: "#",
        instagram: "#",
        email: "katarzyna@norbs.nl"
      }
    },
    {
      id: 5,
      name: "Tomasz Kowalczyk",
      role: t('project_manager'),
      description: t('team_member_5_desc'),
      image: "https://picsum.photos/300/300?random=105",
      skills: ["Project Management", "Scrum", "Client Relations", "Process Optimization"],
      experience: "9+ lat",
      social: {
        linkedin: "#",
        email: "tomasz@norbs.nl"
      }
    }
  ];
  ...
  return (
    <div className="relative w-full py-16">
      ...
      <div className="relative h-[600px] overflow-hidden" ref={carouselRef}>
          ...
          <div className="team-carousel-3d relative w-full h-full">
            {teamMembers.map((member, index) => {
              ...
              return (
                ...
                >
                  {/* Member Card */}
                  <div className={`relative w-80 h-96 bg-gradient-to-br from-background/95 to-muted/95 backdrop-blur-lg rounded-2xl border border-border/50 shadow-2xl transition-all duration-300 overflow-hidden ${
                        ...
                        <div className="space-y-3 animate-fade-in">
                          ...
                          <div className="flex flex-wrap gap-1 justify-center">
                            {member.skills.slice(0, 3).map((skill, skillIndex) => (
                              <span key={skillIndex} className="px-2 py-1 bg-muted/60 text-xs rounded-full text-muted-foreground">
                                {skill}
                              </span>
                            ))}
                          </div>
                          ...
                          <div className="flex justify-center space-x-3 pt-2">
                            {Object.entries(member.social).map(([platform, url]) => (
                              <a
                                ...
                                className="p-2 bg-muted/40 hover:bg-accent hover:text-accent-foreground rounded-full transition-all duration-300 hover:scale-110"
                                title={platform}
                              >
