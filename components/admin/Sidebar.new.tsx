    ...
    <aside className="lg:w-64 flex-shrink-0">
      <div className="lg:sticky lg:top-28">
        <div className="hidden lg:block mb-6">
          <h2 className="text-xl font-bold text-foreground">{t('admin.welcome')}, {user?.name}</h2>
          <p className="text-sm text-muted-foreground">{t('admin.adminPanel')}</p>
        </div>
        <nav className="flex flex-row lg:flex-col gap-2 p-2 bg-muted/50 rounded-xl lg:p-0 lg:bg-transparent lg:rounded-none">
          <NavLink to="/admin/dashboard" className={navLinkClass}>
            ...
            <span className="text-sm sm:text-base">{t('admin.dashboard')}</span>
          </NavLink>
          <NavLink to="/admin/clients" className={navLinkClass}>
            ...
            <span className="text-sm sm:text-base">{t('admin.clients')}</span>
          </NavLink>
          <NavLink to="/admin/projects" className={navLinkClass}>
            ...
            <span className="text-sm sm:text-base">{t('admin.projects')}</span>
          </NavLink>
          <NavLink to="/admin/categories" className={navLinkClass}>
            ...
            <span className="text-sm sm:text-base">{t('admin.categories')}</span>
          </NavLink>
          <NavLink to="/admin/invoicing" className={navLinkClass}>
            ...
            <span className="text-sm sm:text-base">{t('admin.invoicing')}</span>
          </NavLink>
        </nav>
      </div>
    </aside>
