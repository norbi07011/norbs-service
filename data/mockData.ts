...
export let MOCK_TASKS: Task[] = [
    { id: 'task-1', projectId: 'proj-1', title: 'Draft initial ad copy', description: 'Create 3 variations of ad copy for Facebook.', dueDate: new Date('2024-06-15T17:00:00Z').toISOString(), status: 'completed', hoursLogged: 8, createdAt: new Date().toISOString() },
    { id: 'task-2', projectId: 'proj-1', title: 'Design visual assets', description: 'Create visuals for 5 ad sets.', dueDate: new Date('2024-06-30T17:00:00Z').toISOString(), status: 'pending', hoursLogged: 12.5, createdAt: new Date().toISOString() },
    { id: 'task-3', projectId: 'proj-2', title: 'Develop homepage component', description: 'Code the new hero section for the homepage.', dueDate: new Date('2024-05-30T17:00:00Z').toISOString(), status: 'completed', hoursLogged: 16, createdAt: new Date().toISOString() },
    { id: 'task-4', projectId: 'proj-2', title: 'Setup payment gateway integration', description: 'Integrate Stripe for checkout.', dueDate: new Date('2024-06-20T17:00:00Z').toISOString(), status: 'pending', hoursLogged: 0, createdAt: new Date().toISOString() },
];
